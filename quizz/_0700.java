...
Path thisPath = Paths.get("quizz/_0700.java");
...
File file = new File("quizz/_0700.java");
out.println("File length: " + file.length());

UnixFileAttributeView fav = null;
try {
  fav = Files.getFileAttributeView(thisPath,UnixFileAttributeView.class);
} catch(IOException e) {out.println(e);}
